...
import { QUERY_ACENDING_FORTUNES } from "../utils/queries";
import { ASCENDINGFORTUNES_SUBMIT } from "../utils/mutations";
...
import ascendingFortunesLogo from "../assets/images/ascendingFortunes.jpg";

import "../css/luckyPick.css";

const AscendingFortunes = () => {
  const { loading, data, refetch } = useQuery(QUERY_ACENDING_FORTUNES);

  const [submitAscendingFortunes] = useMutation(ASCENDINGFORTUNES_SUBMIT, {
    errorPolicy: "all",
  });
  ...
  const submissions = data?.ascendingFortunesSubmissions || [];
  ...
  return (
    <Container className="luckyPick-container">
      ...
      <Row className="img-header-row text-center">
        <Col>
          <h1 className="mt-4">
            Ascending Fortunes <span>Submission Form</span>
          </h1>
        </Col>
      </Row>
              ...
              <Row className="mt-4">
                <Col md={6}>
                  <Form.Group controlId="jackPot">
                    <Form.Label>Which Jackpot did you play?</Form.Label>
                    <Form.Control
                      as="select"
                      name="jackPot"
                    ...
                    >
                      ...
                      <option value="mini">Major</option>
                      <option value="minor">Grand</option>
                      <option value="minor">Mega</option>
                    </Form.Control>
                  </Form.Group>
...
export default AscendingFortunes;
